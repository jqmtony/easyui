...
public class DesUtil {
    ...
    public static String firstKey = "Easyui is Good!";

    public static String secondKey = "Easyui is Good@";

    public static String thirdKey = "Easyui is Good#";

    public static void main(String[] args) {
        String data = "easyui";

        String str = strEncrypt(data, firstKey, secondKey, thirdKey);
        System.out.println(str);
        String dec = strDecrypt(str, firstKey, secondKey, thirdKey);
     ...
     * @return
     */
    public static String strEncrypt(String data) {
        return strEncrypt(data, firstKey, secondKey, thirdKey);
    }

    /*
     * encrypt the string to string made up of hex return the encrypted string
     */
    public static String strEncrypt(String data, String firstKey, String secondKey, String thirdKey) {
     ...
     * @return
     */
    public static String strDecrypt(String data) {
        return strDecrypt(data, firstKey, secondKey, thirdKey);
    }
     ...
     */
    public static String strDecrypt(String data, String firstKey, String secondKey, String thirdKey) {
        int leng = data.length();
        String decStr = "";
        List firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
        int firstLength = 0, secondLength = 0, thirdLength = 0;
