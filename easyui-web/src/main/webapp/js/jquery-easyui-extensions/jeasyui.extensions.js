...
(function ($, undefined) {
    ...
    $.messager.show = function (options) {
        ...
        var opts = $.extend({},/* $.messager.defaults,*/ { title: "提示信息", timeout: 4000, showType: "slide" ,height: "120px"}, options),
            position = {
        ...
        opts.style = (opts.position && position[opts.position]) ? position[opts.position] : position.bottomRight;
