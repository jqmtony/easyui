...
_4bf.value=_4c0;
if(_4bf.timer){
clearTimeout(_4bf.timer);
}
_4bf.timer=setTimeout(function(){
...
if(_4c3.timer){
clearTimeout(_4c3.timer);
_4c3.timer=undefined;
}
...
}}),tagFormatter:function(_b7b,row){
var opts=$(this).tagbox("options");
return row?row[opts.textField]:_b7b;
},tagStyler:function(_b7c,row){
return "";
},onClickTag:function(_b7d){
},onBeforeRemoveTag:function(_b7e){
},onRemoveTag:function(_b7f){
}});
})(jQuery);
(function($){
function _b80(_b81){
var _b82=$.data(_b81,"datebox");
var opts=_b82.options;
$(_b81).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_b83(this);
_b84(this);
_b85(this);
_b93(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_b82.calendar){
var _b86=$(_b81).combo("panel").css("overflow","hidden");
_b86.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_b86);
...
_b82.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_b82.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _b87=this.target;
var opts=$(_b87).datebox("options");
_b93(_b87,opts.formatter.call(_b87,date));
$(_b87).combo("hidePanel");
opts.onSelect.call(_b87,date);
}});
}
$(_b81).combo("textbox").parent().addClass("datebox");
$(_b81).datebox("initValue",opts.value);
function _b83(_b88){
var opts=$(_b88).datebox("options");
var _b89=$(_b88).combo("panel");
_b89.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _b8a=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_b8a].handler.call(e.target,_b88);
}
});
};
function _b84(_b8b){
var _b8c=$(_b8b).combo("panel");
if(_b8c.children("div.datebox-button").length){
return;
}
var _b8d=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_b8c);
var tr=_b8d.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:;\"></a>").html($.isFunction(btn.text)?btn.text(_b8b):btn.text).appendTo(td);
...
var cc=_b8f.children("div.datebox-calendar-inner");
_b8f.children()._outerWidth(_b8f.width());
_b82.calendar.appendTo(cc);
_b82.calendar[0].target=_b8e;
if(opts.panelHeight!="auto"){
var _b90=_b8f.height();
_b8f.children().not(cc).each(function(){
_b90-=$(this).outerHeight();
});
cc._outerHeight(_b90);
}
_b82.calendar.calendar("resize");
};
};
function _b91(_b92,q){
_b93(_b92,q,true);
};
function _b94(_b95){
var _b96=$.data(_b95,"datebox");
var opts=_b96.options;
var _b97=_b96.calendar.calendar("options").current;
if(_b97){
_b93(_b95,opts.formatter.call(_b95,_b97));
$(_b95).combo("hidePanel");
}
};
function _b93(_b98,_b99,_b9a){
var _b9b=$.data(_b98,"datebox");
var opts=_b9b.options;
var _b9c=_b9b.calendar;
_b9c.calendar("moveTo",opts.parser.call(_b98,_b99));
if(_b9a){
$(_b98).combo("setValue",_b99);
}else{
if(_b99){
_b99=opts.formatter.call(_b98,_b9c.calendar("options").current);
}
$(_b98).combo("setText",_b99).combo("setValue",_b99);
}
};
$.fn.datebox=function(_b9d,_b9e){
if(typeof _b9d=="string"){
var _b9f=$.fn.datebox.methods[_b9d];
if(_b9f){
...
_b9d=_b9d||{};
return this.each(function(){
var _ba0=$.data(this,"datebox");
if(_ba0){
$.extend(_ba0.options,_b9d);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_b9d)});
}
_b80(this);
});
};
...
return $.extend($.data(jq[0],"datebox").options,{width:_ba1.width,height:_ba1.height,originalValue:_ba1.originalValue,disabled:_ba1.disabled,readonly:_ba1.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},initValue:function(jq,_ba2){
return jq.each(function(){
var opts=$(this).datebox("options");
var _ba3=opts.value;
if(_ba3){
_ba3=opts.formatter.call(this,opts.parser.call(this,_ba3));
}
$(this).combo("initValue",_ba3).combo("setText",_ba3);
});
...
$.fn.datebox.parseOptions=function(_ba5){
return $.extend({},$.fn.combo.parseOptions(_ba5),$.parser.parseOptions(_ba5,["sharedCalendar"]));
};
...
_b91(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_ba6){
return $(_ba6).datebox("options").currentText;
},handler:function(_ba7){
var now=new Date();
$(_ba7).datebox("calendar").calendar({year:now.getFullYear(),month:now.getMonth()+1,current:new Date(now.getFullYear(),now.getMonth(),now.getDate())});
_b94(_ba7);
}},{text:function(_ba8){
return $(_ba8).datebox("options").closeText;
},handler:function(_ba9){
...
(function($){
function _baa(_bab){
var _bac=$.data(_bab,"datetimebox");
var opts=_bac.options;
$(_bab).datebox($.extend({},opts,{onShowPanel:function(){
var _bad=$(this).datetimebox("getValue");
_bb3(this,_bad,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_bab).removeClass("datebox-f").addClass("datetimebox-f");
$(_bab).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_bac.spinner){
var _bae=$(_bab).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_bae.children("div.datebox-calendar-inner"));
_bac.spinner=p.children("input");
}
_bac.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator});
$(_bab).datetimebox("initValue",opts.value);
};
function _baf(_bb0){
var c=$(_bb0).datetimebox("calendar");
var t=$(_bb0).datetimebox("spinner");
...
function _bb4(_bb5){
var opts=$.data(_bb5,"datetimebox").options;
var date=_baf(_bb5);
_bb3(_bb5,opts.formatter.call(_bb5,date));
$(_bb5).combo("hidePanel");
};
function _bb3(_bb6,_bb7,_bb8){
var opts=$.data(_bb6,"datetimebox").options;
$(_bb6).combo("setValue",_bb7);
if(!_bb8){
if(_bb7){
var date=opts.parser.call(_bb6,_bb7);
$(_bb6).combo("setText",opts.formatter.call(_bb6,date));
$(_bb6).combo("setValue",opts.formatter.call(_bb6,date));
}else{
$(_bb6).combo("setText",_bb7);
}
}
var date=opts.parser.call(_bb6,_bb7);
$(_bb6).datetimebox("calendar").calendar("moveTo",date);
$(_bb6).datetimebox("spinner").timespinner("setValue",_bb9(date));
function _bb9(date){
function _bba(_bbb){
return (_bbb<10?"0":"")+_bbb;
};
var tt=[_bba(date.getHours()),_bba(date.getMinutes())];
if(opts.showSeconds){
tt.push(_bba(date.getSeconds()));
}
return tt.join($(_bb6).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_bbc,_bbd){
if(typeof _bbc=="string"){
var _bbe=$.fn.datetimebox.methods[_bbc];
if(_bbe){
return _bbe(this,_bbd);
}else{
return this.datebox(_bbc,_bbd);
}
}
_bbc=_bbc||{};
return this.each(function(){
var _bbf=$.data(this,"datetimebox");
if(_bbf){
$.extend(_bbf.options,_bbc);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_bbc)});
}
_baa(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _bc0=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_bc0.originalValue,disabled:_bc0.disabled,readonly:_bc0.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_bc1){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _bc2=opts.value;
if(_bc2){
_bc2=opts.formatter.call(this,opts.parser.call(this,_bc2));
}
$(this).combo("initValue",_bc2).combo("setText",_bc2);
});
},setValue:function(jq,_bc3){
return jq.each(function(){
_bb3(this,_bc3);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_bc4){
var t=$(_bc4);
return $.extend({},$.fn.datebox.parseOptions(_bc4),$.parser.parseOptions(_bc4,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_bb1(this,q);
}},buttons:[{text:function(_bc5){
return $(_bc5).datetimebox("options").currentText;
},handler:function(_bc6){
var opts=$(_bc6).datetimebox("options");
_bb3(_bc6,opts.formatter.call(_bc6,new Date()));
$(_bc6).datetimebox("hidePanel");
}},{text:function(_bc7){
return $(_bc7).datetimebox("options").okText;
},handler:function(_bc8){
_bb4(_bc8);
}},{text:function(_bc9){
return $(_bc9).datetimebox("options").closeText;
},handler:function(_bca){
$(_bca).datetimebox("hidePanel");
}}],formatter:function(date){
var h=date.getHours();
var M=date.getMinutes();
var s=date.getSeconds();
function _bcb(_bcc){
return (_bcc<10?"0":"")+_bcc;
};
var _bcd=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_bcb(h)+_bcd+_bcb(M);
...
var tt=dt[1].split(_bce);
var hour=parseInt(tt[0],10)||0;
var _bcf=parseInt(tt[1],10)||0;
var _bd0=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_bcf,_bd0);
}});
})(jQuery);
(function($){
function init(_bd1){
var _bd2=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_bd1);
var t=$(_bd1);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_bd2.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_bd2.bind("_resize",function(e,_bd3){
if($(this).hasClass("easyui-fluid")||_bd3){
_bd4(_bd1);
}
return false;
});
...
if(_bd6){
if(_bd6.width){
opts.width=_bd6.width;
}
if(_bd6.height){
opts.height=_bd6.height;
}
}
_bd8._size(opts);
if(opts.mode=="h"){
_bd8.css("height","");
_bd8.children("div").css("height","");
}else{
_bd8.css("width","");
_bd8.children("div").css("width","");
_bd8.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_bd8._outerHeight());
}
_bd9(_bd5);
};
function _bda(_bdb){
var _bdc=$.data(_bdb,"slider");
var opts=_bdc.options;
var _bdd=_bdc.slider;
...
_bde(aa);
function _bde(aa){
var rule=_bdd.find("div.slider-rule");
var _bdf=_bdd.find("div.slider-rulelabel");
rule.empty();
_bdf.empty();
for(var i=0;i<aa.length;i++){
var _be0=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_be0);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_bdf);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_be0,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_be0,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _be1(_be2){
var _be3=$.data(_be2,"slider");
var opts=_be3.options;
var _be4=_be3.slider;
_be4.removeClass("slider-h slider-v slider-disabled");
_be4.addClass(opts.mode=="h"?"slider-h":"slider-v");
_be4.addClass(opts.disabled?"slider-disabled":"");
var _be5=_be4.find(".slider-inner");
_be5.html("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_be5.append("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_be4.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_be3.isDragging=true;
opts.onSlideStart.call(_be2,opts.value);
},onStopDrag:function(e){
_be7(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_be2,opts.value);
opts.onComplete.call(_be2,opts.value);
_be3.isDragging=false;
}});
_be4.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_be3.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_be7(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_be2,opts.value);
});
function _be7(pos,_be8){
var _be9=_bea(_be2,pos);
var s=Math.abs(_be9%opts.step);
if(s<opts.step/2){
_be9-=s;
}else{
_be9=_be9-s+opts.step;
}
if(opts.range){
var v1=opts.value[0];
var v2=opts.value[1];
...
if(_be8){
var _beb=$(_be8).nextAll(".slider-handle").length>0;
if(_be9<=v2&&_beb){
v1=_be9;
}else{
if(_be9>=v1&&(!_beb)){
...
_be9<m?v1=_be9:v2=_be9;
}
}
}
$(_be2).slider("setValues",[v1,v2]);
}else{
$(_be2).slider("setValue",_be9);
}
};
};
function _bec(_bed,_bee){
var _bef=$.data(_bed,"slider");
var opts=_bef.options;
var _bf0=_bef.slider;
var _bf1=$.isArray(opts.value)?opts.value:[opts.value];
var _bf2=[];
if(!$.isArray(_bee)){
_bee=$.map(String(_bee).split(opts.separator),function(v){
return parseFloat(v);
});
}
_bf0.find(".slider-value").remove();
var name=$(_bed).attr("sliderName")||"";
...
var _bf4=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_bf0);
_bf4.attr("name",name);
_bf4.val(_bf3);
_bf2.push(_bf3);
var _bf5=_bf0.find(".slider-handle:eq("+i+")");
var tip=_bf5.next();
var pos=_bf6(_bed,_bf3);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_bed,_bf3));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _bf7="left:"+pos+"px;";
_bf5.attr("style",_bf7);
tip.attr("style",_bf7+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _bf7="top:"+pos+"px;";
_bf5.attr("style",_bf7);
tip.attr("style",_bf7+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_bf2:_bf2[0];
$(_bed).val(opts.range?_bf2.join(opts.separator):_bf2[0]);
if(_bf1.join(",")!=_bf2.join(",")){
opts.onChange.call(_bed,opts.value,(opts.range?_bf1:_bf1[0]));
}
};
function _bd9(_bf8){
var opts=$.data(_bf8,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_bec(_bf8,opts.value);
opts.onChange=fn;
};
function _bf6(_bf9,_bfa){
var _bfb=$.data(_bf9,"slider");
var opts=_bfb.options;
var _bfc=_bfb.slider;
var size=opts.mode=="h"?_bfc.width():_bfc.height();
var pos=opts.converter.toPosition.call(_bf9,_bfa,size);
if(opts.mode=="v"){
pos=_bfc.height()-pos;
}
if(opts.reversed){
...
function _bea(_bfd,pos){
var _bfe=$.data(_bfd,"slider");
var opts=_bfe.options;
var _bff=_bfe.slider;
var size=opts.mode=="h"?_bff.width():_bff.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _c00=opts.converter.toValue.call(_bfd,pos,size);
return _c00.toFixed(0);
};
$.fn.slider=function(_c01,_c02){
if(typeof _c01=="string"){
return $.fn.slider.methods[_c01](this,_c02);
}
_c01=_c01||{};
return this.each(function(){
var _c03=$.data(this,"slider");
if(_c03){
$.extend(_c03.options,_c01);
}else{
_c03=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_c01),slider:init(this)});
$(this).removeAttr("disabled");
}
...
_bec(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_c07){
var t=$(_c07);
return $.extend({},$.parser.parseOptions(_c07,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_c08){
return _c08;
},converter:{toPosition:function(_c09,size){
var opts=$(this).slider("options");
return (_c09-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_c0a,_c0b){
},onSlideStart:function(_c0c){
},onSlideEnd:function(_c0d){
},onComplete:function(_c0e){
}};
})(jQuery);
